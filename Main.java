...
public class Main
{
	public static void main(String[] args) {
		...
		System.out.println("There are " + sticks + " sticks. Select 1 to go first, select 2 to go second.");
		...
		//the game stops when we get to 0 sticks.
		//so the game must continue to run as long as the number of sticks is greater than 0.
